...
const components = {
    ...
    h3: (props: any) => <Typography {...props} component="h3" variant="h3" gutterBottom />,
    h4: (props: any) => <Typography {...props} component="h4" variant="h4" gutterBottom />,
    h5: (props: any) => <Typography {...props} component="h5" variant="h5" gutterBottom />,
